...
// Account credentials
const coldAddress = 'rf3wo5pktDqbS8pvJRRztToonuUEn5rGaF';
const coldSecret = 'sEd7jymCE8nZd71tDRtke58nBT6YbAD'; // Secret key will be stored more securely in later vesions 

const hotAddress = 'rhtLtAKxvHUWJoxwLGA2hMLvWL568ofXj2';
const hotSecret = 'sEdTPyCTWtYWeHKqekRS6dVfjcYBqb2'; // Secret key will be stored more securely in later vesions 
...
async function main() {
  ...
  if (pay_result.result.meta.TransactionResult == "tesSUCCESS") {
      ...
      try {
        ...
        console.log(`Sending ${send_to_borrower_quantity} STX from hot to borrower...`);
